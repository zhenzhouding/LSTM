...
# 创建保存文件夹
save_path = '/data/gpfs/projects/punim2189/lstm/dpl_mae'
...
results_df.to_csv(os.path.join('/data/gpfs/projects/punim2189/lstm/kge_results_dpl_mae.csv'), index=False)
