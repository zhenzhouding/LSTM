...
# 创建保存文件夹
save_path = '/data/gpfs/projects/punim2189/lstm/zgh_kge'
...
results_df.to_csv(os.path.join('/data/gpfs/projects/punim2189/lstm/kge_results_zgh_kge.csv'), index=False)
