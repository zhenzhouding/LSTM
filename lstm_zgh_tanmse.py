...
def train_model(units1, units2, batch_size, lr, x_train, y_train, x_val, y_val, x_test, y_test, save_path):
    ...
    model.compile(optimizer=optimizer, loss=tanmse_loss)  # 使用自定义损失函数 tanmse_loss
...
# 读取数据
input_path = '/data/gpfs/projects/punim2189/lstm/zgh_input.xlsx'
...
# 创建保存文件夹
save_path = '/data/gpfs/projects/punim2189/lstm/zgh_tanmse'
...
results_df.to_csv(os.path.join('/data/gpfs/projects/punim2189/lstm/kge_results_zgh_tanmse.csv'), index=False)
