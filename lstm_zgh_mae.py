...
def train_model(units1, units2, batch_size, lr, x_train, y_train, x_val, y_val, x_test, y_test, save_path):
    ...
    model.compile(optimizer=optimizer, loss='mae')  # 修改为 MAE 损失函数
...
# 创建保存文件夹
save_path = '/data/gpfs/projects/punim2189/lstm/zgh_mae'
...
results_df.to_csv(os.path.join('/data/gpfs/projects/punim2189/lstm/kge_results_zgh_mae.csv'), index=False)
